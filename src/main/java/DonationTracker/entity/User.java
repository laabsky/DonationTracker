...
public class User {
     ...
     */
    public User(String firstName, String lastName, String userName, int id, String password, String email) {
    ...
    public int hashCode() {
        ...
        return Objects.hash(firstName, lastName, userName, id, email, password);
    }
}
